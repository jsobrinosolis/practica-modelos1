...
public class HTMLParserTest {
    ...
    public void compruebaEtiquetaInicioHTML() {
        try {
            Token token1 = analizador.yylex();
            Token token2 = analizador.yylex();
            Token token3 = analizador.yylex();
    ...
    public void compruebaInicioYFinEtiquetaHTML() {
        try {
            ...
            Token token4 = analizador.yylex();
            Token token5 = analizador.yylex();
            Token token6 = analizador.yylex();
            Token token7 = analizador.yylex();
